...
const styles = StyleSheet.create({
  ...
  backBtnText: { color: '#10b981', fontSize: 30, fontWeight: '700', lineHeight: 24 },
  headerCenter: { flex: 1, minWidth: 0 },
  headerTitle: { fontSize: 25, fontWeight: '800', color: '#f9fafb', letterSpacing: -0.2 },
  headerTopic: {
    fontSize: 18,
    color: '#10b981',
  ...
  confirmText: { color: '#d1d5db', fontSize: 18, marginBottom: 14, lineHeight: 20 },
  ...
  confirmBtnCancelText: { color: '#9ca3af', fontWeight: '700', fontSize: 18 },
  confirmBtnDelete: {
  ...
  confirmBtnDeleteText: { color: '#fff', fontWeight: '700', fontSize: 18 },
  ...
  emptyTitle: { fontSize: 25, fontWeight: '700', color: '#f9fafb', marginBottom: 6 },
  emptyHint: { fontSize: 18, color: '#6b7280' },
